  ...
  return (
    <div className="flex flex-col items-center space-y-4">
      <button
        ...
        className="bg-blue-600 text-white px-4 py-2 rounded shadow hover:bg-blue-700 flex items-center justify-center transition duration-200"
      >
        <svg
      ...
      <button
        ...
        className="bg-green-600 text-white px-4 py-2 rounded shadow hover:bg-green-700 transition duration-200"
      >
        Continue as Guest
      </button>
    </div>
